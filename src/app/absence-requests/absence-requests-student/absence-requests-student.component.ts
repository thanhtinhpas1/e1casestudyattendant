...
import { AbsenceRequestService } from '../../shared/services/absence-request.service';
import { AppService } from '../../shared/services/app.service';
import { AuthService } from '../../shared/services/auth.service';
import { CreateAbsenceRequestModalComponent } from '../../shared/components/create-absence-request-modal/create-absence-request-modal.component';
...
export class AbsenceRequestsStudentComponent implements OnInit {
    ...
    public constructor(public router: Router, public absenceRequestService: AbsenceRequestService, 
    ...
    public getAbsenceRequests() {
        this.absenceRequestService.getRequestsByStudent(this.authService.current_user.id, this.selectedStatus
            , this.search_text).subscribe(result => {
